...
export class EntradaEntidad {
  ...
  @ManyToOne(() => EventoEntidad, (evento) => evento.entradas)
  evento!: EventoEntidad;

  @ManyToOne(() => TipoEntradaEntidad)
  tipoEntrada!: TipoEntradaEntidad;

  @Column()
  titular!: string;

  @Column({ type: 'enum', enum: EstadoEntrada, default: EstadoEntrada.EMITIDA })
  ...
  historial!: Array<Record<string, string>>;
